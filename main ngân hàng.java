...
public class Main {
    ...
    static void nhapTK(Account tk) {
        System.out.println("Nhập số tài khoản: ");
        tk.setSoTK(sc.nextInt());
        sc.nextLine();
        System.out.println("Nhập tên chủ tài khoản: ");
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("1.Nhập thông tin của các chủ tài khoản\n"
                    + "2.Xuất danh sách thông tin của các khách hàng\n" + "3.Nạp tiền vào tài khoản\n" + "4.Rút tiền\n"
                    + "5.Đáo hạn\n" + "6.Chuyển khoản qua tài khoản khác \n" + "Nhập số khác để thoát menu");
            b = sc.nextInt();
            switch (b) {
                case 1:
